...
Esta rama contiene el flujo de trabajo bioinformático desarrollado para identificar genes diferencialmente expresados (DEG) y caracterizar la variabilidad molecular entre dos fenotipos de obesidad (Obeso 1 vs. Obeso 2). 
...
El análisis se basa en el siguiente ecosistema de herramientas:
